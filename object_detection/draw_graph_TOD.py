...
map50_by_epoch = {}
map_by_epoch = {}
pose_model_pth = "yolov11s-CIOU"
with open(f"결과/{pose_model_pth}/results.txt", "r") as txt_file:
...
plt.title('Precision')
plt.savefig(os.path.join("결과", pose_model_pth, 'precision.jpg'))
...
plt.ylabel('Recall')
plt.title('Recall')
plt.savefig(os.path.join("결과", pose_model_pth, 'recall.jpg'))
...
plt.ylabel('mAP@.5')
plt.title('mAP@.5')
plt.savefig(os.path.join("결과", pose_model_pth, 'map50.jpg'))
...
plt.ylabel('mAP@.5:.95')
plt.title('mAP@.5:.95')
plt.savefig(os.path.join("결과", pose_model_pth, 'map.jpg'))
