...
yolo_labels_dir = "./gt"  # Path containing your YOLO .txt files  # todo
output_json_path = "./output.json"  # Output COCO format JSON file
    ...
    "categories": [
        {
            ...
            "skeleton": [
                ...
                # (4, 6),
                # (5, 7),
                (2,4),(2,3),(3,9),(9,8),(9,11),(10,12),(3,5),(8,2),(11,13),(4,6),(8,10),(5,7)
            ],
        }
    ],
}
...
for label_file in glob.glob(os.path.join(yolo_labels_dir, "*.txt")):
    image_id += 1
    img_width, img_height = 640, 384  # Replace with actual image sizes  # todo
